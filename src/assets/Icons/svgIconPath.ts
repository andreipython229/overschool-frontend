...
export const AttachIconPath = [
    {d: AttachIcon.d1, fill: 'currentColor'},
]; // Attach
...
export const CheckIconPath = [
    {d: CheckIcon.d1, fill: 'currentColor'},
];//Check
...
export const CloudIconPath = [
    {d: CloudIcon.d1, fill: 'currentColor'},
];//cloud
...
export const DeleteIconPath = [
    {d: DeleteIcon.d1, fill: 'currentColor'},
];//trush-square
...
export const DownloadIconPath = [
    {d: DownloadIcon.d1, fill: 'currentColor'},
];//download
...
export const ExitIconPath = [
    {d: ExitIcon.d1, fill: 'currentColor'},
];//Exit

export const EyeIconPath = [
...
export const FilterIconPath = [
    {d: FilterIcon.d1, fill: 'currentColor'},
];//Filter
...
export const PhoneIconPath = [
    {d: PhoneIcon.d1, fill: 'currentColor'},
];//Phone
...
export const RouteIconPath = [
    {d: RouteIcon.d1, fill: 'currentColor'},
];//route-square
...
export const SuccessIconPath = [
    {d: SuccessIcon.d1, fill: 'currentColor'},
];//tick-circle
...
export const UploadIconPath: pathT[] = [
    {d: UploadIcon.d1, fill: 'currentColor'},
];
...
export const VideoIconPath = [
    {d: VideoIcon.d1, fill: 'currentColor'},
];

export const VideoListIconPath = [
    {d: VideoListIcon.d1, fill: 'currentColor'},
];//Video
export const VideoProgressIconPath = [
    {d: VideoProgressIcon.d1, fill: 'currentColor'},
];//Videolist
