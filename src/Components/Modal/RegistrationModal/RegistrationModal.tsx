                ...
                <form onSubmit={formik.handleSubmit}>
                    <div className={styles.container}>
                        ...
                        <div className={styles.main_blockDesc}>
                            ...
                            <p className={styles.main_blockDesc_description}>Я подтверждаю согласие на обработку
                                персональных данных
                                в соответствии с условиями
                                <a href={'/'} rel={'noreferrer'} target={'_blank'}
                                   className={styles.main_blockDesc_link}>Политики
                        ...
                        <div className={styles.main_blockDesc}>
                            ...
                            <p className={styles.main_blockDesc_description}>Принимаю условия
                                <a href={'/'} rel={'noreferrer'} target={'_blank'}
                                   className={styles.main_blockDesc_link}>договора
                                    оферты</a>
                            </p>
                        </div>
