...
export const AppMobile = () => {
  ...
  return (
    <div className={styles.container}>
      <Routes>
        <Route path={Path.InitialPage} element={<Suspense fallback={<LoadingSpinner />}><MobileInitPage /></Suspense>} />
        <Route path={Path.CreateSchool} element={<Suspense fallback={<LoadingSpinner />}><CreateNewSchool /></Suspense>} />
        <Route path={Path.ChooseSchool} element={<Suspense fallback={<LoadingSpinner />}><ChooseSchool /></Suspense>} />

        <Route path={FooterPath.TariffPlans} element={<Suspense fallback={<LoadingSpinner />}><TariffPlans /></Suspense>} />
        <Route path={Path.TariffPlansInfo} element={<Suspense fallback={<LoadingSpinner />}><TariffPlansInfo /></Suspense>} />
        <Route path={Path.ResetPassword} element={<Suspense fallback={<LoadingSpinner />}><ResetPassword /></Suspense>} />
        <Route path={Path.Certificate} element={<Suspense fallback={<LoadingSpinner />}><Certificate /></Suspense>} />
        <Route path={Path.HelpPage}>
          <Route index element={<Suspense fallback={<LoadingSpinner />}><HelpPage /></Suspense>} />
          <Route path={Path.Help} element={<Suspense fallback={<LoadingSpinner />}><HelpSchoolPage /></Suspense>} />
          <Route path={Path.HelpUserAccount} element={<Suspense fallback={<LoadingSpinner />}><HelpUserAccount /></Suspense>} />
          <Route path={Path.HelpSchoolSettings} element={<Suspense fallback={<LoadingSpinner />}><HelpSchoolSettings /></Suspense>} />
          <Route path={Path.HelpOverAI} element={<Suspense fallback={<LoadingSpinner />}><HelpOverAI /></Suspense>} />
          <Route path={Path.HelpCourses} element={<Suspense fallback={<LoadingSpinner />}><HelpCoursesPage /></Suspense>} />
          <Route path={Path.HelpGroupSettings} element={<Suspense fallback={<LoadingSpinner />}><HelpGroupSettings /></Suspense>} />
          <Route path={Path.HelpStudents} element={<Suspense fallback={<LoadingSpinner />}><HelpStudentsPage /></Suspense>} />
          <Route path={Path.HelpCheckHW} element={<Suspense fallback={<LoadingSpinner />}><HelpCheckHW /></Suspense>} />
          <Route path={Path.HelpDomainLink} element={<Suspense fallback={<LoadingSpinner />}><HelpDomainLink /></Suspense>} />
        </Route>
        <Route path={Path.LoginPage} element={<Suspense fallback={<LoadingSpinner />}><LoginPage /></Suspense>} />
        <Route path={Path.SocialAuth} element={<Suspense fallback={<LoadingSpinner />}><SocialAuthPage /></Suspense>} />
        <Route path={Path.Catalog}>
          <Route index element={<Suspense fallback={<LoadingSpinner />}><CourseCatalogPage /></Suspense>} />
          <Route path={Path.CatalogCourse} element={<Suspense fallback={<LoadingSpinner />}><CoureCatalogPreview /></Suspense>} />
        </Route>
        <Route path={Path.School} element={<Suspense fallback={<LoadingSpinner />}><MobileLayOut /></Suspense>}>
          <Route path={FooterPath.PersonalDataTreatmentPolicy} element={<Suspense fallback={<LoadingSpinner />}><PersonalDataTreatmentPolicy /></Suspense>} />
          <Route path={FooterPath.CookiePolicy} element={<Suspense fallback={<LoadingSpinner />}><CookiePolicy /></Suspense>} />
          <Route path={FooterPath.CookiePolicyDisclaimer} element={<Suspense fallback={<LoadingSpinner />}><CookiePolicyDisclaimer /></Suspense>} />
          <Route path={FooterPath.PersonalDataProcessing} element={<Suspense fallback={<LoadingSpinner />}><PersonalDataProcessing /></Suspense>} />
          <Route path={FooterPath.PublicOfferAgreement} element={<Suspense fallback={<LoadingSpinner />}><PublicOfferAgreement /></Suspense>} />
          <Route path={FooterPath.PWA} element={<Suspense fallback={<LoadingSpinner />}><PWA /></Suspense>} />
          <Route path={FooterPath.Agreement} element={<Suspense fallback={<LoadingSpinner />}><Agreement /></Suspense>} />
          {navByRolesConfig[role]}

          <Route path={Path.Profile} element={<Suspense fallback={<LoadingSpinner />}><Profile /></Suspense>} />
        </Route>
        <Route path={`${Path.DefaultSchool}${FooterPath.PersonalDataTreatmentPolicy}`} element={<Suspense fallback={<LoadingSpinner />}><PersonalDataTreatmentPolicy /></Suspense>} />
        <Route path={`${Path.DefaultSchool}${FooterPath.CookiePolicy}`} element={<Suspense fallback={<LoadingSpinner />}><CookiePolicy /></Suspense>} />
        <Route path={`${Path.DefaultSchool}${FooterPath.CookiePolicyDisclaimer}`} element={<Suspense fallback={<LoadingSpinner />}><CookiePolicyDisclaimer /></Suspense>} />
        <Route path={`${Path.DefaultSchool}${FooterPath.PersonalDataProcessing}`} element={<Suspense fallback={<LoadingSpinner />}><PersonalDataProcessing /></Suspense>} />
        <Route path={`${Path.DefaultSchool}${FooterPath.PublicOfferAgreement}`} element={<Suspense fallback={<LoadingSpinner />}><PublicOfferAgreement /></Suspense>} />
        <Route path={'*'} element={<Suspense fallback={<LoadingSpinner />}><PageNotFound /></Suspense>} />
      </Routes>
    </div>
  )
}
