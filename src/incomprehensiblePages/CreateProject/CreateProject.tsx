...
<div className={styles.create}>
    ...
    <div>
      ...
      <p className={styles.create__subtitle}>Назначайте обучение, управляйте доступами, следите за результатами и активностью учеников в удобном для Вас интерфейсе</p>
    </div>
