...
export const CourseImg: FC<CourseImgPropsT> = memo (({currentCourse, changeCurrentCourse, id, alt, img, title}) => {

    return (<section className={styles.init_main_course}>
        <div
            ...
            <img className={styles.init_main_course_block_img}
                 src={img} alt={alt}/>
            <span className={styles.init_main_course_block_blur}/>
            <h2 className={currentCourse === id
