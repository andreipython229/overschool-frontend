...
export default function WebinarPage() {
  ...
  const playbackSessionId =
    publicWebinarData && 'playback_session_id' in publicWebinarData ? (publicWebinarData as PublicWebinarLive).playback_session_id : undefined
  ...
  const { message, videoId, videoType, uploadedVideoUrl, scheduledStartTime, videoOffsetSeconds } = useMemo(() => {
  ...
  const predefinedComments =
    chatMessagesData?.all_scripted_messages.map((msg: ChatMessage) => ({
