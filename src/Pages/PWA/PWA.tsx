  ...
  return (
    <section className={styles.PWA}>
      <div className={styles.PWA_header}>
        ...
        <p>
          Установите CourseHUB как приложение на ваш телефон для более удобного использования. 
          Приложение работает офлайн и обеспечивает быстрый доступ к курсам.
        </p>
      </div>
      ...
      <div className={styles.PWA_content}>
        <div className={styles.PWA_card}>
          <div className={styles.PWA_card_header}>
            <div className={`${styles.PWA_card_header_icon} ${styles.PWA_card_header_safari}`}>
              🍎
            </div>
        ...
        <div className={styles.PWA_card}>
          <div className={styles.PWA_card_header}>
            <div className={`${styles.PWA_card_header_icon} ${styles.PWA_card_header_chrome}`}>
              🌐
            </div>
      ...
      <div className={styles.PWA_info}>
        ...
        <p>
          После установки CourseHUB как приложения вы получите доступ к расширенным возможностям 
          и более удобному интерфейсу для обучения.
        </p>
