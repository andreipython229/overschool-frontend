...
export const StudentCourseHeader: FC = () => {
    ...
    const school = localStorage.getItem('school') || window.location.href.split('/')[4]
            ...
            <div className={styles.previous_courseInfo}>
                ...
                {countOfLessons && countOfLessons['homework'] &&
                    <div style={{marginRight: '32px', display: 'flex', alignItems: 'center'}}>
                        ...
                        <span>
                            {`${countOfLessons['homework']} ${getNounDeclension(countOfLessons['homework'], ['задание', 'задания', 'заданий'])}`}
                        </span>
                    </div>}
                {countOfLessons && countOfLessons['test'] &&
                    <div style={{display: 'flex', alignItems: 'center'}}>
                        ...
                        <span>
                            {`${countOfLessons['test']} ${getNounDeclension(countOfLessons['test'], ['тест', 'теста', 'тестов'])}`}
                        </span>
                    </div>}
            </div>
