...
{planFeatures[plan.name].disabled?.map((disabledFeature, index) => (
  <li key={`disabled-${index}`} className={`${styles.featureItem} ${styles.listItemDisabled}`}>
    <img src={disabledFeature.icon} alt="Иконка" /> {disabledFeature.text}
  </li>
))}
...
>
  <li>
    ...
    <span style={{ color: 'white', marginLeft: 8 }}>Создание ГБ</span>
  </li>
  <li>
    <img src="/images/layerWhite.png" alt="icon" />
    <span style={{ color: 'white', marginLeft: 8 }}>Создание курсов</span>
  </li>
  <li>
    <img src="/images/studentWhite.png" alt="icon" />
    <span style={{ color: 'white', marginLeft: 8 }}>До 30 учеников</span>
  </li>
  <li>
    <img src="/images/Component 133White.png" alt="icon" />
    <span style={{ color: 'white', marginLeft: 8 }}>До 3 сотрудников</span>
  </li>
</ul>
