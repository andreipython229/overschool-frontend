    ...
    <section className={styles.TariffPlansPage}>
      <div className={styles.TariffPlansPage_plansBlock}>
        ...
        <div className={styles.TariffPlansPage_plansBlock_typeSelect}>
          <div
            className={
              isCourseShown ? styles.TariffPlansPage_plansBlock_typeSelect_courseEnabled : styles.TariffPlansPage_plansBlock_typeSelect_courseDisabled
            }
          >
          ...
          <div
            className={
              isWebinarShown
                ? styles.TariffPlansPage_plansBlock_typeSelect_webinarEnabled
                : styles.TariffPlansPage_plansBlock_typeSelect_webinarDisabled
            }
          >
