...
export const StudentInfoGraphic = (courseId: any) => {
  ...
  axios.get('http://45.135.234.137:8000/api/courses/'+courseId.courseId+'/user_count_by_month/').then((v) => {
    if (v.data.count > 0) {
      setData2([ {
        name: 'Май',
        uv: v.data.count,
  ...
  return (<><div className={styles.statistics_new_student_wrapper_new_students}>
