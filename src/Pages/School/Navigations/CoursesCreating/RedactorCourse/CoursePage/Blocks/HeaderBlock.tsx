...
export const HeaderBlock: FC<HeaderBlockT> = ({ openModal }) => {
  ...
  return (
    <div className={styles.previous}>
      ...
      <div className={styles.previous_bcgrShadow} onClick={handleImageChange}></div>
      <div className={styles.previous_onlineCourses}>
        <input type="text" maxLength={256} value={titleValue} onChange={handleChangeTitle} placeholder="Название курса" />
      </div>
