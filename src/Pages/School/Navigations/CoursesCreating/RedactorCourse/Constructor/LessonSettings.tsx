...
export const LessonSettings: FC<ClassesSettingsPropsT> = memo(({deleteLesson, lessonIdAndType, setType}) => {
            ...
            switch (block.type) {
                case BLOCK_TYPE.TEXT:
                    if ('description' in block && block.description) {
                        return (
                            <NewTextEditor key={block.id} text={block.description} block={block}
                                           setLessonBlocks={setLessonBlocks} lessonBlocks={lessonBlocks}/>
                        )
                    } else {
                        return <NewTextEditor key={block.id} text="" block={block} setLessonBlocks={setLessonBlocks}
    ...
    const handleTestCheck = (e: any) => {
        ...
        setPreviousTests(previousTests.map((test) => ({
            ...test,
                            ...
                            <>
                                ...
                                <>
                                    {(files || lesson.audio_files) && (
                                        <div>
                                            {lesson.audio_files &&
                                                <AudioPlayer audioUrls={lesson.audio_files} delete={deleteAudio}/>}
