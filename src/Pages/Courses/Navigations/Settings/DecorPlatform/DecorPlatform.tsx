    ...
    <div className={styles.wrapper_actions}>
      <div className={styles.decor}>
        ...
        <LogoAddBlock
          ...
          logotype={Cover}
          logoDesc={
            "Загрузите логотип Вашей компании: он будет отображаться в интерфейсе и системных email"
          }
          ...
          requirementsArr={[
            ...
            " Оптимальный размер логотипа 200px х 50px",
          ]}
        />
        <LogoAddBlock
          title={"Ваш favicon"}
          logotype={Cover}
          logoDesc={
            "Загрузите favicon Вашей компании: он будет отображаться на страницах вашей школы во вкладке браузера"
          }
          ...
          requirementsArr={[
            ...
            "Оптимальный размер favicon 100px х 100px",
          ]}
        />
      </div>
    </div>
