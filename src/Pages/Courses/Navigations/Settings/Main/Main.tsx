        ...
        <div className={styles.wrapper_actions}>
            <div className={styles.main}>
                ...
                <p className={styles.main_description}>Название проекта отображается в шапке на главной странице
                    проекта</p>
                <div>
                    <input value={name} onChange={(e) => setName(e.currentTarget.value)} className={styles.main_input}
                           type="text"
                           placeholder={"Название"}/>
                    <button onClick={onChangeProjectName} className={styles.main_btn}>Применить</button>
                </div>
            </div>
        </div>
    );
