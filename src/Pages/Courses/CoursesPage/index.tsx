...
import { AdminView } from './CourseCard/AdminView'
...
export const CoursesPage: FC = memo(() => {
  ...
  return (
    <div className={styles.container}>
      <Input name="search" type="search" value={nameCourses} onChange={filterData} placeholder="Поиск по курсам">
