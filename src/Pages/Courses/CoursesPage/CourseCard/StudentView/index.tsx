    ...
    return (
        <>
            <figure className={styles.course_card_img}>
                <img width="242" height="146" className={styles.course_card_img} src={course?.photo} alt={course.name}/>
            </figure>
            ...
            <div className={styles.course_card_about}>
                ...
                >
                    <div className={styles.course_card_about_progressWrapper}>
                        <img src={pie} alt="pie"/>
                        <span className={styles.course_card_about_progressWrapper_title}>13% jkhk</span>
                    </div>
