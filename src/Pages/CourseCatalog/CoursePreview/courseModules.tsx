...
export const CatalogCourseModules: FC<CatalogModulesT> = ({ section, sectionIndex, handleToggleOpen, openIndex }) => {
  return (
      ...
      <div onClick={() => handleToggleOpen(sectionIndex)} className={styles.accardionWrapper_component_header}>
        ...
        >
          <IconSvg
            ...
            path={[{ ...accardionArrPath[0], fill: openIndex === sectionIndex ? '#808080' : '#357EEB' }]}
          />
        </span>
      </div>
      {openIndex === sectionIndex && (
