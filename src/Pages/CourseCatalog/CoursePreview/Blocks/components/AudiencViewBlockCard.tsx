  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.wrapper_imageBox}>
        ...
        /> */}
        <img src={landing.audience.chips[position].photo} alt={landing.audience.chips[position].photo} width={170} height={170} />
      </div>
      <div className={styles.wrapper_title}>
        <div className={styles.wrapper_title_text}>{landing.audience.chips[position].title}</div>
      </div>
      <div className={styles.wrapper_description}>
        <div className={styles.wrapper_description_text}>{landing.audience.chips[position].description}</div>
      </div>
    </div>
  )
}
