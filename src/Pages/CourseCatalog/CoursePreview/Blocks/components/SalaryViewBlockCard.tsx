  ...
  return (
    <div className={`${styles.wrapper} ${isFirst ? styles.firstWrapper : ''}`}>
        <div className={styles.wrapper_imageBox}>
            <img
                src={landing.income.chips[position].photo}
                alt={landing.income.chips[position].photo}
                width={100}
                height={150}
            />
        </div>
