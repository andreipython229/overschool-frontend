...
const colors: string[] = [
  '#93CEF3', '#93A6F3', '#A693F3', '#D693F3',
  '#ED93F3', '#F393B8', '#F3BD93', '#C6F393',
  '#93A6F3', '#D5F393', '#93CEF3', '#F393E8'
];
      ...
      <div className={styles.wrapper_body}>
        ...
        <div className={styles.search}>
          ...
          >
            ...
            <StyledInputBase value={searchValue} onChange={handleFilter} placeholder="Поиск по курсам…" inputProps={{ 'aria-label': 'поиск' }} sx={{ width: '100%', paddingLeft: '8px' }} />
          </Search>
        </div>
        {isFetching || isLoading ? (
          ...
          <div className={styles.wrapper_body_courses}>
            {courses.results.map((course: any, index: number) => (
              <Card className={styles.wrapper_body_courses_card} sx={{ cursor: 'pointer', transition: 'all ease-in 0.2s', backgroundColor: '#CFE2FF'}} key={index}>
