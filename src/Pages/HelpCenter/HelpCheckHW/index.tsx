      ...
      <div className={styles.sections}>
        ...
        <div className={styles.section}>
          <div className={styles.text_part}>
            ...
            >{`После создания группы и последующего добавления в неё пользователей, у вас появится возможность добавить одного и более менторов.`}</p>
            <p
              className={styles.section_text}
            >{`Они, в свою очередь, будут заниматься проверкой домашних заданий и поддержкой пользователей в изучении материала.`}</p>
          </div>
        ...
        <div className={styles.section}>
          <div className={styles.img_part}>
            <img src={loginBtn} alt="чат с помощником" />
          </div>
          <div className={styles.text_part}>
            <div className={styles.section_title}>
            ...
            <p
              className={styles.section_text}
            >{`Посмотреть работы пользователей можно в навигационной панели во вкладке Домашние задания. На данной странице ментору будут доступны работы пользователей, которые он может фильтровать по разным катергориям и статусам.`}</p>
            <p className={styles.section_text}>
              {`Далее ментор проверяет домашнее задание, выставляет оценку(макс. 10 баллов), и присваивает статус Принято или Отклонено.По желанию у ментора будет возможность оставить комментарии к заданию и прикрепить файл по необходимости.`}
            </p>
          </div>
        </div>
      </div>
