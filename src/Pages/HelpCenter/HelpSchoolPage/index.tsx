    ...
    <section className={styles.HelpCenterPage}>
      ...
      <div className={styles.HelpCenterPage_FAQ}>
        ...
        <p>
          ...
          <br /> Аккаунт онлайн-платформы — отдельный проект с уникальным адресом на платформе OVERSCHOOL. Внутри аккаунта у вас есть личный кабинет
          владельца, где вы можете создавать курсы и управлять платформой.
          <br />
          Для регистрации введите название платформы, электронную почту, номер телефона и пароль
          <a style={{ color: '#BA75FF', fontWeight: '600' }} href="https://overschool.by/create-school/">
            {' '}
        ...
        <p>
          {' '}
          После регистрации аккаунта вы попадаете на главную страницу сайта. Для входа на страницу созданной онлайн-платформы нажмите на кнопку
          &quot;Войти&quot; в правом верхнем углу страницы.
        </p>
        <div className={styles.HelpCenterPage_FAQ_images}>
          <img src={register2} alt="Главнвя страница" className={styles.HelpCenterPage_FAQ_images_firstStep} />
        </div>
        <p>
          Для входа потребуется ввести электронную почту и пароль, котрые вы указали при регистрации платформы. Вы сразу попадёте на учебный портал,
