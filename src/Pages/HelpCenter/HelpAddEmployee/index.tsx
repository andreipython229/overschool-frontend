      ...
      <div className={styles.sections}>
        ...
        <div className={styles.section}>
          <div className={styles.text_part}>
            ...
            >{`Здесь вы сможете добавлять новых сотрудников платформы. При добавлении  нового сотрудника вы указываете его email, на который позже ему придёт сообщение с данными для входа.`}</p>
          </div>
          <div className={styles.img_part}>
            <img src={help3} alt="Окно входа" />
          </div>
        </div>

        <div className={styles.section}>
          <div className={styles.img_part}>
            <img src={help4} alt="Кнопка входа" />
          </div>
          <div className={styles.text_part}>
            <p
              className={styles.section_text}
            >{`По ролям на выбор будут предлагаться два варианта: ментор и  администратор. Внешний вид страницы платформы пользователя с ролью  "Администратор" никак не отличается от вашего. Но у пользователя с ролью  "Ментор" будет ряд ограничений, ему не будут доступны настрйоки  платформы, а внешний вид страницы школы будет следующим:`}</p>
          </div>
        </div>
        ...
        <div className={styles.section}>
          <div className={styles.text_part}>
            ...
            <p className={styles.section_text}>
              {`Для того, чтобы ваши пользователи получали сертификаты с вашими, их нужно добавить, перейдя во вкладку `}
              <strong>&quot;Печати и подписи&quot;</strong>
            </p>
            <p
              className={styles.section_text}
            >{`Следует отметить, что к добавлению подлежат только изображения, отвечающие следующим рекомендациям:`}</p>
            <ol>
              <li>Формат файла PNG (без заднего фона)</li>
              <li>Размер файла не более 2 мб</li>
              <li>Оптимальный размер печати 200px х 200px</li>
            </ol>
          </div>
          <div className={styles.img_part}>
            <img src={help5} alt="Окно входа" />
          </div>
        </div>

        <div className={styles.section}>
          <div className={styles.img_part}>
            <img src={help6} alt="Кнопка входа" />
          </div>
          <div className={styles.text_part}>
            <div className={styles.section_title}>
            ...
            <p className={styles.section_text}>
              ...
              <a href="https://prodamus.ru" target="_blank" rel="noopener noreferrer">
                Prodamus
              </a>
              ,
              <a href="https://express-pay.by" target="_blank" rel="noopener noreferrer">
                ExpressPay
              </a>
              .
            </p>
            <p
              className={styles.section_text}
            >{`Выберите  подходящую для вас и зарегситрируйтесь на ней. После перейдите во  вкладку "Оплата курсов", там нажать кнопку "Добавить способ оплаты" и  внести все необходимые реквизиты в форму:`}</p>
          </div>
        </div>
      </div>
