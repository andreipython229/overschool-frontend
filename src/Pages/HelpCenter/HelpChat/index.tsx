    ...
    return (
        <section className={styles.HelpCenterPage}>
            ...
            <div className={styles.HelpCenterPage_FAQ}>
                <h1>Как создать чат с учениками в онлайн-платформе OVERSCHOOL </h1>
                <h2>Создание чата</h2>
                <p>В онлайн-школе вы можете общаться с учениками через групповые и индивидуальные чаты.
                    <br/>Для создания группового чата просто создайте группу учеников, и чат автоматически создастся с
                ...
                <p> Также для чата с отдельным учеником вы можете перейти на вкладку &quot;Ученики курса&quot; и нажать
