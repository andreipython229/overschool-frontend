  ...
  return (
    <section className={styles.HelpCenterPage}>
      ...
      <div className={styles.HelpCenterPage_FAQ}>
        ...
        <p>
          В личном кабинете вашей школы выберите опцию &quot;Создать курс&quot;.
          <br />
          После ввода названия курса он станет доступен для редактирования. Теперь вы можете создать структуру курса, добавляя тематические модули и
          наполняя их занятиями. Следующим этапом станет добавление пользователей.
        </p>
        ...
        <p>
          После создания модулей, добавьте в них занятия. Занятия могут быть трех типов: обычные, домашние задания и тесты. <br />
          При создании занятия можно использовать текст, видео, изображения и код, а также прикреплять необходимые файлы. <br />
          Для создания занятия-теста укажите название теста и требуемый процент правильных ответов. Затем укажите вопросы и варианты ответов на них,
          которые могут быть представлены как текстом, так и картинками.
        </p>
        <div className={styles.HelpCenterPage_FAQ_images}>
        ...
        <p>
          Для добавления пользователей создайте требуемое количество групп, выберете нужную вам группу и нажмите добавить пользователей. Заполните
          форму данными пользователей и отправьте приглашение.
        </p>
        <div className={styles.HelpCenterPage_FAQ_images}>
          <img src={addStudents} alt="Добавление пользователей" className={styles.HelpCenterPage_FAQ_images_addStudents} />
        </div>
        <p>
          Также для групп есть возможность добавления менторов. Для этого необходимо выбрать менторов, доступных в вашей школе. Добавить менторов в
          школу можно в настройках, в разделе &quot;Сотрудники&quot;.
        </p>
      </div>
