      ...
      <div className={styles.sections}>
        ...
        <div className={styles.section}>
          <div className={styles.text_part}>
            ...
            >{`Аккаунт онлайн-платформы — отдельный проект с уникальным адресом на платформе Course Hub. Внутри аккаунта у вас есть личный кабинет владельца, где вы можете создавать курсы и управлять платформой.Для регистрации введите название платформы, электронную почту и пароль на официальном сайте.`}</p>
          ...
          <div className={styles.img_part}>
            <img src={loginImg} alt="Окно входа" />
          </div>
        </div>
      </div>
