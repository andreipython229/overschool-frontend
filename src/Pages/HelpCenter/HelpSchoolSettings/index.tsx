      ...
      return (
        <section className={styles.HelpSchoolSettings}>
          ...
          <div className={styles.HelpSchoolSettings_FAQ}>
            ...
            <h2> Переходим на страничку настроек школы </h2>
            <p> 
            ...
            <h2> Настроим оформление шапки вашей школы </h2>
            <p>
            ...
            <p>
              Здесь вы сможете изменить фон секции, короткое описание, а также название и аватар школы. После внесения всех 
            ...
            <h2> Основные настройки школы </h2>
            <p> 
            ...
            <p>
              Здесь можно поменять название школы, которое будет отображаться в адресах, относящихся к вашей школе.
              Если вы делились с кем либо url ссылками на вашу школу - то после изменения по старым url адресам она 
              ...
              по которой можно перейти и ознакомится) и ссылку на связь с руководством школы (сслыка на вашу страничку или группу
              в любой социальной сети, где с вами можно связаться по вопросам школы)
            </p>

            <h2> Управление сотрудниками школы </h2>
            <p> 
            ...
            <p>
              Здесь вы сможете добавлять новых сотрудников школы. При добавлении нового сотрудника вы указываете егоё email, 
              на который позже ему придёт сообщение с данными для входа.
              <br/><br/>
              По ролям на выбор будут предлагаться два варианта: ментор и администратор. Внешний вид страницы школы пользователя 
              с ролью &quot;Администратор&quot; никак не отличается от вашего. Но у пользователя с ролью &quot;Ментор&quot; 
              будет ряд ограничений, ему не будут доступны настрйоки школы, а внешний вид страницы школы будет следующим:
            </p>
            <div className={styles.HelpSchoolSettings_FAQ_images}>
