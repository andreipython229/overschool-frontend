...
import platformSettings from "@/assets/img/help/Изображение для 'помощь_ (7).png"
import platformSettings2 from "@/assets/img/help/Изображение для 'помощь_ (8).png"
      ...
      <div className={styles.sections}>
        ...
        <div className={styles.section}>
          <div className={styles.text_part}>
            ...
            >{`Для редактирования оформления нажмите кнопку "Настроить страницу курсов". Найти её можно чуть ниже иконки пользователя`}</p>
            <p
              className={styles.section_text}
            >{`Здесь вы сможете изменить фон секции, короткое описание, а также название и аватар платформы. После внесения всех изменений нажмите кнопку "Завершить настройку курсов"`}</p>
          </div>
        ...
        <div className={styles.section}>
          ...
          <div className={styles.text_part}>
            ...
            <p
              className={styles.section_text}
            >{`Здесь можно поменять название платформы, которое будет отображаться в адресах, относящихся к вашей платформе. Если вы делились с кем либо url ссылками на вашу платформу - то после изменения по старым url адресам она будет не доступна. Частая смена не рекомендуется.`}</p>
            <p
              className={styles.section_text}
            >{`Также здесь можно внести ссылку на адрес публичного договора оферты (web-ссылка на ваш договор, по которой можно перейти и ознакомится) и ссылку на связь с руководством платформы (сслыка на вашу страничку или группу в любой социальной сети, где с вами можно связаться по вопросам платформы)`}</p>
          </div>
        </div>
      </div>
