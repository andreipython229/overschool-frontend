...
export const AboutUser: FC<AboutUserPropsT> = memo(({
    ...
    return (
        <div style={{width: 'calc(100% * 0.6)', marginRight: '26px', marginBottom: '108px'}}
            ...
            <div className={styles.profile_block}>
                <Input name={'Name'} type={'text'} label={'Имя и Фамилия:'} onChange={e => changeFullName(e)}
                       value={full_name}/>
            </div>
            <div className={styles.profile_block}>
                <Input name={'phone'} type={'text'} label={'Телефон:'} onChange={e => changePhoneNumber(e)}
                       value={phone_number} placeholder={'Введите номер телефона'}/>
            </div>
            <div className={styles.profile_block}>
                <Input name={'city'} type={'text'} label={'Город:'} onChange={e => changeCity(e)}
                       value={city} placeholder={'Введите город'}/>
            </div>
            <div className={styles.profile_block}>
                ...
                <textarea className={styles.profile_block_textArea}
                          ...
                          placeholder={aboutUser ? aboutUser : 'Опишите вашу карьеру и достижения. Эта информация будет отображена на страницах курсов, в которых вы являетесь преподавателем'}/>
            </div>
            <div className={styles.profile_block}>
