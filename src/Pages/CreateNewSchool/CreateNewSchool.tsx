            ...
            <div className={styles.newCoursePage_logoWrapper}>
                <div className={styles.newCoursePage_logoWrapper_container}>
                    <svg width="230" height="103" viewBox="0 0 230 103" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        />
                        <defs>
                            <linearGradient id="paint0_linear_1323_4107" x1="140.844" y1="0.0844086" x2="209.849"
                                            y2="59.4753" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#9228FF"/>
                                <stop offset="1" stopColor="#EC40FF"/>
                            </linearGradient>
                            <linearGradient id="paint1_linear_1323_4107" x1="150.641" y1="0.0597811" x2="67.4794"
                                            y2="103.714" gradientUnits="userSpaceOnUse">
                                <stop stopColor="#CD99FF"/>
                                <stop offset="1" stopColor="#6D1CBA"/>
                            </linearGradient>
                            <linearGradient id="paint2_linear_1323_4107" x1="8.10532" y1="38.9434" x2="70.8075"
                                            y2="102.291" gradientUnits="userSpaceOnUse">
