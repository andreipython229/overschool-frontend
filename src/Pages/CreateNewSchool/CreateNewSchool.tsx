    ...
    return (
        <section className={styles.newCoursePage}>
            <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title"
                ...
                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        Поздравляем, Вы стали на шаг ближе к своей цели. Теперь вы можете авторизоваться под данными
                        Вашей, только что созданной, учётной записи и
            ...
            <div className={styles.newCoursePage_btnBack}>
                <button style={{zIndex: 10, background: 'transparent', border: 'none'}}
                        onClick={() => navigate(generatePath(Path.InitialPage))}>
                    <svg className={styles.iconDefault} width="44" height="44" viewBox="0 0 44 44" fill="none"
                    ...
                    <svg className={styles.iconHover} width="44" height="44" viewBox="0 0 44 44" fill="none"
                         xmlns="http://www.w3.org/2000/svg">
        ...
        <span className={styles.newCoursePage_formWrapper_form_btnCreateWrapper_return} onClick={returnLogin}>
          Войти
                ...
                <form className={styles.newCoursePage_formWrapper_form} onSubmit={formik.handleSubmit}>
                    ...
                    <p className={styles.newCoursePage_formWrapper_form_title_comment}>Создайте свой уникальный
                        проект</p>
                    <div className={styles.newCoursePage_formWrapper_form_eMailWrapper}>
                        {error && <p style={{color: 'red', marginTop: '.5em'}}>{error}</p>}
                        <p className={styles.newCoursePage_formWrapper_form_eMailWrapper_title}>Введите название Вашей
                            платформы:</p>
                        <InputAuth
                            name={'school_name'}
                            type={'text'}
                    ...
                    <div className={styles.newCoursePage_formWrapper_form_eMailWrapper}>
                        ...
                        {formik.touched.email && formik.errors.email ?
                            <p style={{color: 'red', marginTop: '.5em'}}>{formik.errors.email}</p> : null}
                    </div>
                    ...
                    <div className={styles.newCoursePage_formWrapper_form_passwordWrapper}>
                        ...
                        {formik.touched.password && formik.errors.password ?
                            <p style={{color: 'red', marginTop: '.5em'}}>{formik.errors.password}</p> : null}
                    </div>
                    <div className={styles.newCoursePage_formWrapper_form_passwordWrapper}>
                    ...
                    <div className={styles.newCoursePage_formWrapper_form_btnCreateWrapper}>
                        <Button
                            text={isLoading ?
                                <SimpleLoader style={{width: '2em', height: '2em'}}/> : 'Создать свой проект'}
                            variant={'newCreate'}
                            type={'submit'}
