...
import { google } from '../../assets/img/common/index'
      ...
      <div className={styles.newCoursePage_logoWrapper}>
        <svg width="332" height="186" viewBox="0 0 332 186" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            ...
            fill="white"
          />
          <path d="M151.604 167.458H138.452V141.252H110.145V167.458H96.9927V104.747H110.145V130.04H138.452V104.747H151.604V167.458Z" fill="white" />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            ...
            fill="black"
          />
          <path d="M14.6715 48.787H12.8134H9.09577H7.23765L7.27789 58.9767L10.9553 63.6204L14.6715 58.988L14.6715 48.787Z" fill="#357EEB" />
          <path
