            ...
            {settingsActive === 0 ? (
                <>
                    <div style={{marginTop: '15px'}} className={styles.usually_input}>
                        ...
                        <Input placeholder={'Основы языка HTML'} name={'name classes'} onChange={handleNameClasses}
                    ...
                    {checkbox ? (
                        <div className={styles.tasks_credit}>
                            ...
                            <div className={styles.tasks_credit_select}>
                                <SelectInput optionsList={arrNumber} optionName={'number' as keyof object}
                                             setSelectedValue={setTime}/>
                                <SelectInput optionsList={arrTime} optionName={'unit' as keyof object}
                                             setSelectedValue={setUnits}/>
                            </div>
                ...
                <div>
                    <span
                        className={styles.usually_title}>Сколько баллов будет выдано ученику по завершению занятия:</span>
                    <div className={styles.usually_grade}>
                        <input type={'number'} placeholder={'0'} value={balls} onChange={handleBallsClasses}
