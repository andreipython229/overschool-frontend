          ...
          Баллы за прохождение
            ...
            {settingsActive === 0 ? (
                <div className={styles.usually_input}>
                    ...
                    <Input placeholder={'Основы языка HTML'} name={'name classes'} onChange={changeNameClasses}
                ...
                <div>
                    ...
                    <div className={styles.usually_grade}>
                        <input type={'number'} placeholder={'0'} className={styles.usually_grade_points} value={balls}
                               onChange={changeBallsClasses}/>
                        <span>баллов</span>
                    </div>
                </div>
            )}
