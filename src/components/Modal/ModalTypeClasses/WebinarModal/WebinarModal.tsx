        ...
        >
          ...
          Баллы за прохождение
            ...
            {settingsActive === 0 ? (
                <>
                    <div style={{marginTop: '15px'}} className={styles.usually_input}>
                        ...
                        <Input placeholder={'Основы языка HTML'} name={'name classes'} onChange={changeName}
                               type={'text'} value={nameClasses}/>
                    </div>
            ...
            <div className={styles.btnBlock}>
                ...
                />
                <Button onClick={() => console.log('заглушка')} text={'Добавить занятие'} variant={'primary'}/>
            </div>
        </div>
    )
}
