          ...
          <form className={styles.container} onSubmit={formikforgot.handleSubmit}>
            ...
            <div className={styles.inputs_block}>
              <div>
                ...
                <div className={styles.errors_forgot}>{formikforgot.errors.email || (errorSend && 'Неверная почта')}</div>
                <div className={styles.isSubmitting}>{formikforgot.isSubmitting || (sendSuccess && 'Письмо отправлено')}</div>
              </div>
            </div>
            <div className={styles.container_wrapper}>
              <Button style={{}} className={styles.profile_block_btn} type="submit" variant={'primary'} text={'Отправить'} />
            </div>
          </form>
        </div>
      )}
