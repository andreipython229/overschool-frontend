    ...
    <div className={styles['modal-wrapper']} style={{ display: isOpen ? 'block' : 'none' }}>
      <div className={styles['modal-content']}>
        ...
        <div className={styles['input-container']}>
          <input type="text" id="templateName" value={templateName} onChange={handleTemplateNameChange} />
        </div>
        <div className={styles['label-container']}>
        ...
        <div className={styles['input-container']}>
          <input type="text" id="delayDays" value={delayDays} onChange={handleDelayDaysChange} />
        </div>
        <div className={styles['checkbox-container']}>
          Рассылать шаблон &nbsp;
          <Checkbox name={'isPublic'} checked={sendNewsletter} onChange={handleSendNewsletterChange} className={styles['custom-checkbox']} />
        </div>
        <div>
