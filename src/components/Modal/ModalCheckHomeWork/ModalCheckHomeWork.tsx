        ...
        <div className={styles.modal_container}>
            ...
            <div className={styles.modal_visibility_block}>
                ...
                <div className={styles.bottomButtons}>
                    <button
                        className={styles.bottomButtons_btn_addFile}>
                        <IconSvg width={22} height={18} d={classesSettingSvgIcon.paperClip} viewBoxSize="0 0 22 18" fill={'#6B7280'} />
                        <span>Прикрепить файл</span>
                    </button>
                    <button
                        className={styles.bottomButtons_btn_mark}>
                        <IconSvg width={17} height={17} d={starSvgIcon} viewBoxSize="0 0 17 17" fill={"#E5E7EB"} stroke="#E0DCED" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        <span>0</span>
                    </button>
                    <button
                        className={styles.bottomButtons_btn_done}>
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M6.08687 8.42085C6.31468 8.19305 6.68402 8.19305 6.91183 8.42085L9.99935 11.5084L13.0869 8.42085C13.3147 8.19305 13.684 8.19305 13.9118 8.42085C14.1396 8.64866 14.1396 9.01801 13.9118 9.24581L10.4118 12.7458C10.184 12.9736 9.81468 12.9736 9.58687 12.7458L6.08687 9.24581C5.85906 9.01801 5.85906 8.64866 6.08687 8.42085Z" fill="#4BC3AF"/>
                        </svg>

                    </button>
                    <button
                        className={styles.bottomButtons_btn_send}>
                        <IconSvg width={20} height={20} d={sendSvgIcon} viewBoxSize="0 0 20 20" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
