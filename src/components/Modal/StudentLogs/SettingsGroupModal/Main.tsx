    ...
    <>
      <PrimeReactProvider>
        <div className={styles.groupSetting_input}>
          <Input name={'groupName'} value={title} type={'text'} label={'Название группы:'} onChange={handleChangeGroupName} />
        </div>
        {groupType === 'WITH_TEACHER' ? (
          ...
          <p className={styles.groupSetting_description}>
        ...
        <div className={styles.groupSetting_checkboxBlock}>
          ...
          <div className={styles.groupSetting_checkboxBlock_checkbox}>
            <Checkbox id={'submitHomework'} name={'submitHomework'} checked={submitHomework} onChange={handlerHomeworkSubmit} />
            <div className={styles.groupSetting_checkboxBlock_checkbox_desc}>
          ...
          <div className={styles.groupSetting_checkboxBlock_checkbox}>
            <Checkbox id={'submitTest'} name={'submitTest'} checked={submitTest} onChange={handlerTestSubmit} />
            <div className={styles.groupSetting_checkboxBlock_checkbox_desc}>
          ...
          <div className={styles.groupSetting_checkboxBlock_checkbox}>
            <Checkbox id={'successTest'} name={'successTest'} checked={successTest} onChange={handlerTestSuccess} />
            <div className={styles.groupSetting_checkboxBlock_checkbox_desc}>
        ...
        <div className={styles.groupSetting_courseAccess_header}>
          ...
          {isSelectNextCourses ? (
            ...
            <span className={styles_check.accardion_content_fake}></span>
          )}
        </div>
        {isSelectNextCourses && (
          <div className={styles.groupSetting_courseAccess_content}>
            ...
            <div className={styles.courseSelect}>
              <select onChange={e => addCourse(e.target.value)}>
                ...
                {checkCourses &&
                  checkCourses.map(({ course_id, name }) => (
            ...
            {selectedCourses.map(({ course_id, name, student_groups, selected_group }, index) => (
