  ...
  return (
    <>
      <div className={styles.groupSetting_input}>
        <Input name={'groupName'} value={''} type={'text'} label={'Название группы:'} />
      </div>
      <div className={styles.groupSetting_checkboxBlock}>
        <div className={styles.groupSetting_checkboxBlock_checkbox}>
          ...
          <div className={styles.groupSetting_checkboxBlock_checkbox_desc}>
            ...
            <span>
              Ученики будут видеть домашние задания, смогут их выполнять, но не смогут отправлять их
              вам на проверку
            </span>
          </div>
        </div>
        <div className={styles.groupSetting_checkboxBlock_checkbox}>
          <Checkbox
            id={'strongSubsequence'}
            name={'strongSubsequence'}
            checked={strongSubsequence}
            onChange={handlerSubsequence}
          />
          <div className={styles.groupSetting_checkboxBlock_checkbox_desc}>
            <span>Строгая последовательность занятий</span>
            <span>
              Ученик сможет приступить к следующему занятию только после прохождения предыдущего
            </span>
          </div>
        </div>
      </div>
      {strongSubsequence && (
        <div className={styles.groupSetting_selectBlock}>
          <div className={styles.groupSetting_selectBlock_select}>
            ...
            <SelectInput
              optionsList={[
                'Необходимо получить зачёт',
                'Необходимо отправить решение',
                ' Можно пропустить',
              ]}
            />
          </div>
          <div className={styles.groupSetting_selectBlock_select}>
            <span>Тесты</span>
            <SelectInput
              optionsList={['Можно пропустить', 'Необходимо пройти', 'Необходимо успешно пройти']}
            />
          </div>
        </div>
      )}
