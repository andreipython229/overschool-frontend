    ...
    <>
      ...
      >
        ...
        <DialogContent className={styles.modal_window}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            *Рекомендуется загружать видеофайл напрямую. При использовании ссылки на YouTube возможны ограничения функционала из-за условий
          ...
          <div style={{ marginBottom: '1rem' }}>
            <input
              ...
              ref={fileInputRef}
              style={{ display: 'none' }}
              onChange={e => setNewWebinarData({ ...newWebinarData, video: e.target.files?.[0] })}
            />
            ...
            >
              <span className={styles.input_span}>{newWebinarData.video?.name || 'Загрузите видео...'}</span>
              <button
                type="button"
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            >
              <span className={styles.input_span}>{jsonFileName || 'Загрузите json-файл с комментариями...'}</span>
              <button
                type="button"
