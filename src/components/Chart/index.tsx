...
//           d={linePath}
//         />
//         {data.map((item: { name: string; value: string | boolean | d3.NumberValue | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactNode | null | undefined; }, index: React.Key | null | undefined) => {
//           // eslint-disable-next-line @typescript-eslint/ban-ts-comment
//           // @ts-ignore
//           return (
//             <g key={index}>
