...
useEffect(() => {
  ...
  const ChevronLeftIcon = () => (
    <svg className={styles.chevroLeft} width="17" height="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512">
    ...
    <div className="fixed-button">
      ...
      {isDialogOpen && (
        <div className={styles.modalOverlay} onClick={handleOverlayClick}>
          <div
              className={`${styles.dialog} ${isDialogOpen && styles.dialogOpen} ${showWelcomeMessage && styles.noGradient}`}>
            ...
            <p className={`${styles.overAiHeader}`}>
              OVER AI
            </p>
                  ...
                  <>
                    ...
                    {!selectedChatId && (
                        <div className={`${styles.leftPane}`}>
                          {isFetchingChats ? (
                              ...
                              <>
                                <button className={styles.createChatButtonModal} onClick={handleCreateEmptyChat}
                                ...
                                {Object.entries(chatData)
                                    ...
                                    <span className={styles.centeredText}>
                                      ...
                                      <button className={styles.deleteChatBtn}
                                              onClick={() => handleDeleteChat(Number(chatId))}>
                                            <IconSvg width={19} height={19} viewBoxSize="0 0 19 19"
                                                     path={deleteIconPath}/>
                                        </button>
                                    </span>
                                        </div>
                    ...
                    {selectedChatId && (
                        <div className={`${styles.rightPane}`}>
                          <button className={styles.dialog_close} onClick={backToChats}>
                            <ChevronLeftIcon/>
                          </button>
                                ...
                                <span>
                                  ...
                                  {userQuestion.sender_question}
                                          ...
                                          {index < botAnswers.length && (
                                              <div className={styles.messageContainer_bot} key={index}
                            ...
                            />
                                  <button onClick={() => handleSendMessage(messageInput)}
                                    ...
                                    <svg viewBox="0 0 16 13" fill="none" xmlns="http://www.w3 org/2000/svg">
                                      <path
                                          d="M7.17278 1.21787C7.56956 0.633707 8.43044 0.633706 8.82722 1.21787L15.5994 11.1881C16.0503 11.8521 15.5748 12.75 14.7722 12.75H1.22785C0.425231 12.75 -0.0503452 11.8521 0.400629 11.1881L7.17278 1.21787Z"
                                          fill="white"/>
                                    </svg>
                                  </button>
