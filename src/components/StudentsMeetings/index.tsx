...
export const StudentSchoolMeeting: FC = () => {
              ...
              {meetingsData.slice(show, showMore).map((meeting, index) => (
                <tr key={meeting.id} className={styles.meetingTable_container}>
                  ...
                  <td className={styles.meetingTable_deisign}>
                    <img className={styles.meetingTable_deisign_img} src={cardAvatar} alt="deisign" />
                  </td>
                  <td className={styles.meetingTable_ref}>
                    ...
                    <a className={styles.meetingTable_ref_link} href={meeting.link} target="_blank" rel="noopener noreferrer">
                      {meeting.link}
                    </a>
                  </td>
                  <td className={styles.meetingTable_prop}>
                    ...
                    <tr className={styles.meetingTable_prop_time}>
                      <Timer targetDate={new Date(meeting.start_date)} />
                    </tr>
                  </td>
                </tr>
              ))}
  ...
  return <div>{renderMeetingLinks()}</div>
}
