...
export const Student: FC<StudentPropsT> = memo(({ avatar, name, email, balls, progress, date, commentary }) => {
  return (
    <div className={styles.student_info_table_contents_wrapper_content}>
      ...
      <div className={styles.student_info_table_contents_wrapper_content_student_email}>{email}</div>
      ...
      <div className={styles.student_info_table_contents_wrapper_content_student_activity}>{date}</div>
      <div className={styles.student_info_table_contents_wrapper_content_student_activity}>{commentary}</div>
    </div>
  )
})
