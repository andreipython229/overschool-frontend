    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.wrapper_drop_down_menu}>
        ...
        <div className={styles.wrapper_optionsContent}>
                    ...
                    {answer.picture && (
                      <>
                        <div style={{ marginBottom: '10px' }}>
                          <img src={answer.picture} alt="Selected Image" width={180} height={82} style={{ borderRadius: '16px', display: 'block' }} />
                        </div>
          ...
          {/* {isAddButtonVisible && ( */}
          <div className={styles.wrapper_addButton}>
            <Button text={'+ Добавить вариант'} variant={'newPrimary'} onClick={handleAddAnswer} />
          </div>
          {/* )} */}
        </div>
      </div>
