...
export const QuestionHeader:FC<QuestionHeaderT>= memo(({children}) => {
  ...
  return (
    <div className={styles.header}>
        ...
        <div className={styles.header_controlIconWrapper}>
            <div className={styles.header_controlIconWrapper_timer}>
                <IconSvg width={15} height={15} viewBoxSize="0 0 19 19">                                                
                    <g clipPath="url(#clip0_2875_4565)">
                        ...
                        <path d="M8.35352 0.617188C4.21139 0.617188 0.853516 3.97506 0.853516 8.11719C0.853516 12.2593 4.21139 15.6172 8.35352 15.6172C12.4956 15.6172 15.8535 12.2593 15.8535 8.11719C15.8535 3.97506 12.4956 0.617188 8.35352 0.617188ZM8.35352 14.6172C4.76367 14.6172 1.85352 11.707 1.85352 8.11719C1.85352 4.52734 4.76367 1.61719 8.35352 1.61719C11.9434 1.61719 14.8535 4.52734 14.8535 8.11719C14.8535 11.707 11.9434 14.6172 8.35352 14.6172Z" fill="#17B198"/>
                    </g>
                    <defs>
            ...
            <div className={styles.header_controlIconWrapper_togglerShowOption}>
            ...
            <div className={styles.header_controlIconWrapper_delete}>
