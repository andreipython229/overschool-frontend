...
export const StudentLessonNavBtns: FC<studentLessonNavBtnsT> = memo(({ courseId, sectionId, lessonType, lessonId, activeLessonIndex, lessons }) => {
  ...
  return (
    <div className={styles.lesson__btns}>
      <Button
        onClick={() =>
          navigate(`/school/School_1/courses/student-course/${courseId}/module/${sectionId}/${lessonBack?.type || lessonType}/${lessonBack?.id}`)
        }
      ...
      <Button
        onClick={() =>
          navigate(
            `/school/School_1/courses/student-course/${courseId}/module/${sectionId}/${lessonForward?.type || lessonType}/${lessonForward?.id}`,
          )
        }
