...
export const CoursePage = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/CoursePage').then(module => ({ default: module.CoursePage })),
)
export const RedactorCourse = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/RedactorCourse').then(module => ({ default: module.RedactorCourse })),
)
export const Constructor = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/Constructor/Constructor').then(module => ({ default: module.Constructor })),
)
export const SettingCourse = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/SettingCourse/SettingCourse').then(module => ({ default: module.SettingCourse })),
)
export const StudentsStats = lazy(() => import('../Pages/School/StudentsStats/StudentsStats').then(module => ({ default: module.StudentsStats })))
export const CoursePageConstruct = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/CoursePage/CoursePage').then(module => ({
    default: module.CoursePageConstruct,
  })),
)
export const Comments = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/Comments/Comments').then(module => ({ default: module.Comments })),
)
...
export const Materials = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/MaterialsPage').then(module => ({ default: module.Materials })),
)
export const CourseMaterials = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/CourseMaterials/CourseMaterials').then(module => ({
    default: module.CourseMaterials,
  })),
)
...
export const NotificationBanner = lazy(() =>
  import('../Pages/Settings/NotificationBannerSettings').then(module => ({ default: module.NotificationBanner })),
)
export const Rating = lazy(() => import('../Pages/Rating').then(module => ({ default: module.Rating })))
export const AdminOrTeacherReplyHomework = lazy(() =>
  import('../Pages/HomeWork/AdminOrTeacherReply').then(module => ({ default: module.AdminOrTeacherReplyHomework })),
)
...
export const SettingsInvitesProgram = lazy(() =>
  import('../Pages/Settings/InviteProgram').then(module => ({ default: module.SettingsInvitesProgram })),
)
export const CertificateComponent = lazy(() =>
  import('../Pages/School/Navigations/CoursesCreating/RedactorCourse/Certificates/Certificate').then(module => ({ default: module.default })),
)
export const StudentCourse = lazy(() => import('../Pages/StudentCourse').then(module => ({ default: module.StudentCourse })))
export const StudentLessonPreview = lazy(() =>
  import('../Pages/StudentCourse/StudentLessonPreview').then(module => ({ default: module.StudentLessonPreview })),
)
